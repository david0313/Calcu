        ...
        do{
            ...
            switch(opcion){
                case 1:
                    ...
                    JOptionPane.showMessageDialog(null,"La suma es: " + operar.suma(num1, num2));
                break;
                    
                case 2:
                    num1=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el primer valor:"));
                    num2=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el segundo valor: "));
                    JOptionPane.showMessageDialog(null,"La resta es: " + operar.resta(num1,num2));
                break; 
                    
                case 3:
                    num1=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el primer valor:"));
                    num2=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el segundo valor: "));
                    JOptionPane.showMessageDialog(null,"La multiplicacion es: " + operar.multiplicacion(num1,num2));
                break;
               ...
               case 4:
                   ...
                   JOptionPane.showMessageDialog(null,"La division es: " + operar.division(num3, num4));
                break; 
